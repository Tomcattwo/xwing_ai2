#!/usr/bin/env python
"""
X-wing Miniatures AI Ship 2nd Edition
"""
import copy
...
class Ship:
    ...
    def isValid( self, maneuver ):
        """
        Return: Boolean of if the given maneuver is valid for this ship
        """
    ...
    def generate_tables( self ):
        ...
        self.closing.append( self.generate_row( [F, R, STA], [TRL, TRR, SLL, SLR, K, RBL, RBR], [BR, BL], "slow" ) )
        ...
        self.closing.append( self.generate_row( [BR], [TR, R, RBL, STA], [F], "slow" ) )
        ...
        elif self.name in [ "decimator", "hwk290", "hwk290S" ]:
            # Special case as this ship does not support Koiogran Turn
